...
public class BuscarRegistrosTotal extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BuscarRegistrosTotal frame = new BuscarRegistrosTotal();
	 ...
	 * Create the frame.
	 */
	public BuscarRegistrosTotal() {
		setTitle("Buscar Registros - Contatos 1.0");
		...
		btnDeletar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (Contato c : Lista) {
					...
					BuscarRegistrosTotal.adicionarTable(c);
				}
